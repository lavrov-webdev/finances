...
import { SumInfo } from "../../coomponents/SumInfo";
import { FC } from "react";
import { useParams } from "react-router-dom";
import { treatSprintInfo } from "../../helpers";
import { Envelope } from "../../coomponents";
...
export const SprintPage: FC = () => {
    ...
    return (
        <Grid2 container columns={2} gap={6}>
            ...
            <Grid2>
                <Box mb={2} fontWeight={500}><div style={{display: "flex", justifyContent: "space-between"}}><span>Категория</span><span>План</span><span>Расходы</span><span>Остаток</span><span/></div></Box>
